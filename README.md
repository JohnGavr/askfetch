...
## Contributing
Consult the [contribution guide](https://github.com/JohnGavr/askfetch/blob/master/CONTRIBUTING.md) for contribution directions regarding askfetch.
...
## Πώς να συμβάλλετε
Συμβουλευτείτε τον [αντίστοιχο οδηγό](https://github.com/JohnGavr/askfetch/blob/master/CONTRIBUTING.md) για οδηγίες σχετικά με την υποβολή κώδικα.
